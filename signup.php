...
<body class="bg-light">
    <div class="container p-5 d-flex flex-column align-items-center">
        ...
        <p class="text-center" style="font-weight: 600; color: navy;">Please fill in the details to create your account.</p>
        ...
        <form method="post" class="form-control mt-5 p-4"
            ...
            <div class="mb-2 mt-3">
                ...
                <div class="mt-3 text-center">
                    <p style="font-weight: 600;">Already have an account? <a href="./login.php" style="text-decoration: none;">Login here</a></p>
                </div>
            </div>
        </form>
    </div>
