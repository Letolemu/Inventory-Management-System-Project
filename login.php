...
<body class="bg-light">
    <div class="container p-5 d-flex flex-column align-items-center">
        ...
        <h5 class="text-center p-4" 
          style="font-weight: 700;">Welcome Back! Please Login</h5>
            ...
            <div class="col mb-3 mt-3">
                <button type="submit" 
                  class="btn btn-success bg-success" style="font-weight: 600;">Login to Your Account</button>
            ...
            <div class="col mb-2 mt-4">
                <p class="text-center" 
                  ...
                  ><a href="./signup.php"
                        style="text-decoration: none;">Don't have an account? Create one</a>
